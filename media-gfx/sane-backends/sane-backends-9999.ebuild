...
inherit autotools eutils flag-o-matic multilib multilib-minimal udev user toolchain-funcs git-2
...
#		"${FILESDIR}"/${P}-saned_pidfile_location.patch
	epatch "${FILESDIR}"/${PN}-automagic_systemd.patch \
		"${FILESDIR}"/${PN}-systemd_pkgconfig.patch \
		"${FILESDIR}"/${PN}-saned_pidfile_location.patch
	# Fix for "make check".
