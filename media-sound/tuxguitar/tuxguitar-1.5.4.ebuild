...
PATCHES=( "${FILESDIR}"/${PN}-1.5.2-build-fixes.patch )
...
src_prepare() {
	...
	sed -e "s|../TuxGuitar/lib/commons-compress.jar|$(java-pkg_getjar commons-compress commons-compress.jar)|" \
		-i TuxGuitar-gpx/build.properties || die "sed TuxGuitar-gpx/build.properties failed"
	...
	LIBRARY_LIST=( TuxGuitar-lib TuxGuitar-editor-utils TuxGuitar-ui-toolkit
		 TuxGuitar-ui-toolkit-swt TuxGuitar-gm-utils TuxGuitar $(usex pdf TuxGuitar-awt-graphics "")
	)
